    ...
    <div class="row">
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading" align="center">Nueva Compra - Ingreso</div>
                          ...
                          <div class="panel panel-primary">                     
                            <div class="panel-body">
                              <label>Medicamento</label>
                                    <select id="idmed" name="idmedicamento" class="form-control" onchange="actualizar();">                          
                                      @foreach($medicamentos as $med)
                                      <option  class="form-group" precio="{{$med->pc}}" stock="{{$med->stock}}" value="{{$med->idmedicamento}}" >{{$med->nombre}} {{$med->descripcion}}  {{$med->presentacion}} stock[{{$med->stock}}]</option>
